Shader "Custom/SnowCoverShader_Transparent"
{
	Properties
	{
		...
		SubShader
			{
				...
				// ERIK: alphatest:_AlphaCutoff tells our shader to use the _AlphaCutoff variable to check if a pixel
				// is "cut off" or not. Parts on the texture with an alpha > this value will be visible.
